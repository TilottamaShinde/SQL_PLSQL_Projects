...
BEGIN
    ...
    SELECT basic_salary, hra, special_allowance, other_allowance, pf_deduction, professioanl_tax, income_tax
    ...
    INSERT INTO employee_payslip (
		emp_id, pay_month, basic_salary, hra, special_allowances, other_allowance,
        total_earnings, total_deductions, net_pay, status, generated_on, remarks
    )
    VALUES (
		p_emp_id, p_pay_month, v_basic, v_hra, v_special, v_other,
        v_total_earnings, v_total_deductions, v_net_pay, 'Finalized', NOW(), 'Auto-generated'
    );
   END //
